# 019: Coding Agent Refactor into AgentSession Architecture
...
- RPC mode (ADR-020), hooks (ADR-021), and bash mode (ADR-018) all became cleaner because they target `AgentSession` instead of scattered internals.
