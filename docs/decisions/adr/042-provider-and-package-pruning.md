# 042: Provider and Package Pruning
...
- Users who relied on these providers must switch to alternatives or re-add them as custom providers via the extension API (ADR-037).
