...
const allowedInstallScriptPackages = new Map([
	...
	["better-sqlite3@11.7.0", "native binding compile, required for webui's SessionPool"],
	["fsevents@2.3.3", "macOS-only fs watcher, transitive dep of chokidar (webui dep)"],
]);
