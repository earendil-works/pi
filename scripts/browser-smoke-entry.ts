...
import { createAssistantMessageEventStream, Type } from "@tculpepp/spi-ai";
import { complete, getModel, getProviders, streamSimple } from "@tculpepp/spi-ai/compat";
import {
	Agent,
	bashExecutionToText,
	convertToLlm,
...
import { decodeCbor, encodeCbor, PROTOCOL_VERSION } from "@tculpepp/spi-protocol";
