...
tmux send-keys -t pi-test "cd /Users/tculpepp/projects/pi-mono && ./pi-test.sh" Enter
...
### Attribution
- **Internal changes (from issues)**: `Fixed foo bar ([#123](https://github.com/tculpepp/secure-pi-mono/issues/123))`
