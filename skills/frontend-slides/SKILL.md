...
Load the `frontend-design` skill and apply its full design framework to every
presentation. If the skill is not available, follow the principles in [STYLE_PRESETS.md](STYLE_PRESETS.md) as a fallback.
