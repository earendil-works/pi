...
async function generateModels() {
	...
	// Tencent Cloud Token Plan Individual (Common Token Plan). One prepaid endpoint
	// shared by the Individual plans; the Common and Hy plan catalogs differ, so the
	// documented Common model IDs are declared here. models.dev only carries the Hy
