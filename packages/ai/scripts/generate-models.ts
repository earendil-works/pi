...
async function generateModels() {
	...
	// LiteLLM gateway models — curated set pointing at a local LiteLLM proxy.
	// Users run `litellm --config config.yaml --port 4000` and select provider "litellm".
	const LITELLM_BASE_URL = "http://localhost:4000/v1";
	const LITELLM_COMPAT: OpenAICompletionsCompat = {
		supportsStore: false,
		supportsDeveloperRole: false,
		supportsReasoningEffort: false,
		maxTokensField: "max_tokens",
	...
	const litellmModels: Model<"openai-completions">[] = [
		{ id: "anthropic/claude-sonnet-4-6", name: "Claude Sonnet 4.6 (via LiteLLM)", api: "openai-completions", provider: "litellm", baseUrl: LITELLM_BASE_URL, compat: LITELLM_COMPAT, reasoning: false, input: ["text", "image"], cost: { input: 3, output: 15, cacheRead: 0.3, cacheWrite: 3.75 }, contextWindow: 200000, maxTokens: 8192 },
		{ id: "openai/gpt-4o", name: "GPT-4o (via LiteLLM)", api: "openai-completions", provider: "litellm", baseUrl: LITELLM_BASE_URL, compat: LITELLM_COMPAT, reasoning: false, input: ["text", "image"], cost: { input: 2.5, output: 10, cacheRead: 1.25, cacheWrite: 0 }, contextWindow: 128000, maxTokens: 16384 },
		{ id: "openai/gpt-4.1", name: "GPT-4.1 (via LiteLLM)", api: "openai-completions", provider: "litellm", baseUrl: LITELLM_BASE_URL, compat: LITELLM_COMPAT, reasoning: false, input: ["text", "image"], cost: { input: 2, output: 8, cacheRead: 0.5, cacheWrite: 0 }, contextWindow: 1047576, maxTokens: 32768 },
		{ id: "google/gemini-2.5-flash", name: "Gemini 2.5 Flash (via LiteLLM)", api: "openai-completions", provider: "litellm", baseUrl: LITELLM_BASE_URL, compat: LITELLM_COMPAT, reasoning: true, input: ["text", "image"], cost: { input: 0.15, output: 0.6, cacheRead: 0.0375, cacheWrite: 0 }, contextWindow: 1048576, maxTokens: 65536 },
		{ id: "groq/llama-4-scout-17b-16e-instruct", name: "Llama 4 Scout 17B (via LiteLLM)", api: "openai-completions", provider: "litellm", baseUrl: LITELLM_BASE_URL, compat: LITELLM_COMPAT, reasoning: false, input: ["text"], cost: { input: 0.11, output: 0.34, cacheRead: 0, cacheWrite: 0 }, contextWindow: 131072, maxTokens: 8192 },
		{ id: "mistral/mistral-large-latest", name: "Mistral Large (via LiteLLM)", api: "openai-completions", provider: "litellm", baseUrl: LITELLM_BASE_URL, compat: LITELLM_COMPAT, reasoning: false, input: ["text"], cost: { input: 2, output: 6, cacheRead: 0, cacheWrite: 0 }, contextWindow: 128000, maxTokens: 8192 },
	];
	providers["litellm"] = {};
	for (const model of litellmModels) {
		providers["litellm"][model.id] = model;
