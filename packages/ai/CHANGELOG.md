...
- Fixed OpenAI Responses and Azure OpenAI Responses `streamSimple()` requests near the context limit to avoid sending `max_output_tokens` below the provider minimum.
