...
- Added provider-neutral request cache breakpoints, verified explicit-cache lowering, and cache read/write reporting availability.
- Added bounded Codex uncertain-outcome diagnostics and owner-turn continuation settlement controls.
...
- Fixed Codex transports to avoid retry, reconnect, fallback, or replay after provider dispatch.
