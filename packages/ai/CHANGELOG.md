...
- Fixed `cacheRetention: "none"` to disable implicit prompt-cache writes for supported OpenAI models ([#6618](https://github.com/earendil-works/pi/pull/6618) by [@tmustier](https://github.com/tmustier)).
