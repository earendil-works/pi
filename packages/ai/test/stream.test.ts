...
describe("Generate E2E Tests", () => {
	...
	describe.skipIf(!process.env.MELIOUS_API_KEY)("Melious Provider (GLM-5.1 via OpenAI Completions)", () => {
		...
		it("should handle image input", { retry: 3 }, async () => {
			await handleImage(getModel("melious", "mistral-small-3.2-24b-instruct"));
		});
	});
