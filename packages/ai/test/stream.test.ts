...
describe("Generate E2E Tests", () => {
	...
	describe.skipIf(!process.env.FIREPASS_API_KEY)(
		"Fireworks FirePass Provider (Kimi K2.6 Turbo via OpenAI Completions)",
		() => {
			const llm = getModel("firepass", "accounts/fireworks/routers/kimi-k2p6-turbo");
