...
describe("Tool Call Without Result Tests", () => {
	...
	describe.skipIf(!process.env.QWEN_TOKEN_PLAN_CN_API_KEY)("Qwen Token Plan Individual (CN) Provider", () => {
		const model = getModel("qwen-token-plan-individual-cn", "qwen3.8-max");
