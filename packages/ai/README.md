...
```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@tculpepp/spi-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@tculpepp/spi-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@tculpepp/spi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@tculpepp/spi-ai';
...
```typescript
import { getModel, stream } from '@tculpepp/spi-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@tculpepp/spi-ai';
...
```typescript
import { Model, stream } from '@tculpepp/spi-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@tculpepp/spi-ai';
...
```typescript
import { getModel, complete, Context } from '@tculpepp/spi-ai';
...
```typescript
import { Context, getModel, complete } from '@tculpepp/spi-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@tculpepp/spi-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@tculpepp/spi-ai';
...
The library provides login and token refresh functions via the `@tculpepp/spi-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@tculpepp/spi-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@tculpepp/spi-ai/oauth';
...
```typescript
import { getModel, complete } from '@tculpepp/spi-ai';
import { getOAuthApiKey } from '@tculpepp/spi-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@tculpepp/spi-ai`
