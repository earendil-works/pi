...
```bash
npm install @tculpepp/pi-ai
```

TypeBox exports are re-exported from `@tculpepp/pi-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@tculpepp/pi-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@tculpepp/pi-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@tculpepp/pi-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@tculpepp/pi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@tculpepp/pi-ai';
...
```typescript
import { getModel, stream } from '@tculpepp/pi-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@tculpepp/pi-ai';
...
```typescript
import { Model, stream } from '@tculpepp/pi-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@tculpepp/pi-ai';
...
```typescript
import { getModel, complete, Context } from '@tculpepp/pi-ai';
...
```typescript
import { Context, getModel, complete } from '@tculpepp/pi-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@tculpepp/pi-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@tculpepp/pi-ai';
...
```bash
npx @tculpepp/pi-ai login              # interactive provider selection
npx @tculpepp/pi-ai login anthropic    # login to specific provider
npx @tculpepp/pi-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@tculpepp/pi-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@tculpepp/pi-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@tculpepp/pi-ai/oauth';
...
```typescript
import { getModel, complete } from '@tculpepp/pi-ai';
import { getOAuthApiKey } from '@tculpepp/pi-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@tculpepp/pi-ai`
