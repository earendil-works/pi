 ...
 */
function isRetryableBaseten429(error, model, signal) {
...
function resolveBasetenRetryOptions(model, retryOverride) {
 ...
 */
function getRetryDelay(attempt, baseDelay, maxDelay, error) {
