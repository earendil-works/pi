...
export declare function projectAnthropicRequest(model: Model<"anthropic-messages">, context: Context, options?: AnthropicOptions, isOAuthToken?: boolean): MessageCreateParamsStreaming;
