...
export const CLOUDFLARE_AI_GATEWAY_MODELS = {
	...
	"claude-fable-5": {
		...
		provider: "cloudflare-ai-gateway",
		baseUrl: "https://gateway.ai.cloudflare.com/v1/{CLOUDFLARE_ACCOUNT_ID}/{CLOUDFLARE_GATEWAY_ID}/anthropic",
		compat: {"sendSessionAffinityHeaders":true,"forceAdaptiveThinking":true,"supportsStrictTools":true},
		reasoning: true,
	...
	"claude-haiku-4-5": {
		...
		provider: "cloudflare-ai-gateway",
		baseUrl: "https://gateway.ai.cloudflare.com/v1/{CLOUDFLARE_ACCOUNT_ID}/{CLOUDFLARE_GATEWAY_ID}/anthropic",
		compat: {"sendSessionAffinityHeaders":true,"supportsStrictTools":true},
		reasoning: true,
		input: ["text", "image"],
		cost: {
			input: 1,
	...
	"claude-opus-4-7": {
		...
		provider: "cloudflare-ai-gateway",
		baseUrl: "https://gateway.ai.cloudflare.com/v1/{CLOUDFLARE_ACCOUNT_ID}/{CLOUDFLARE_GATEWAY_ID}/anthropic",
		compat: {"sendSessionAffinityHeaders":true,"forceAdaptiveThinking":true,"supportsTemperature":false,"supportsStrictTools":true},
		reasoning: true,
