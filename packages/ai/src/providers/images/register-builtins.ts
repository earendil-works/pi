...
/**
 * Wraps a dynamically imported image API module as an `ImagesFunction`. The
 * module loads on first call and stays cached; load failures are reported as an
 * errored `AssistantImages` rather than thrown.
 */
