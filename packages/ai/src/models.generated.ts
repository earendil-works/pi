...
export const MODELS = {
	...
	"deepseek": {
		"deepseek-v4-flash": {
			...
			compat: {"thinkingFormat":"deepseek","supportsDeveloperRole":false,"supportsStore":false,"reasoningEffortMap":{"minimal":"high","low":"high","medium":"high","high":"high","xhigh":"max"}},
			reasoning: true,
			input: ["text"],
			cost: {
				input: 0.14,
