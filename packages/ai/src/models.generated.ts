...
export const MODELS = {
	...
	"dashscope": {
		"qwen3.7-max": {
			...
			compat: {"thinkingFormat":"qwen","supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":false,"maxTokensField":"max_tokens","cacheControlFormat":"anthropic","requiresReasoningContentOnAssistantMessages":true},
			reasoning: true,
			thinkingLevelMap: {"xhigh":"xhigh"},
			thinkingBudgets: {"minimal":4096,"low":8192,"medium":32768,"high":131072,"xhigh":262144},
			input: ["text"],
			cost: {
				input: 0.83,
				output: 2.5,
