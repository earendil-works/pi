...
export const MODELS = {
	...
	"routing-run": {
		"route/deepseek-v3.2": {
			...
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsUsageInStreaming":true,"maxTokensField":"max_tokens","supportsStrictMode":false,"thinkingFormat":"deepseek"},
			reasoning: true,
			input: ["text"],
			cost: {
				input: 0.4928,
		...
		"route/deepseek-v4-flash": {
			...
			provider: "routing-run",
			baseUrl: "https://api.routing.run/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsUsageInStreaming":true,"maxTokensField":"max_tokens","supportsStrictMode":false,"thinkingFormat":"deepseek","requiresReasoningContentOnAssistantMessages":true},
			reasoning: true,
			thinkingLevelMap: {"minimal":null,"low":null,"medium":null,"high":"high","xhigh":"max"},
			input: ["text"],
			cost: {
		...
		"route/deepseek-v4-pro-precision": {
		...
		"route/glm-4.7": {
			...
			provider: "routing-run",
			baseUrl: "https://api.routing.run/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsUsageInStreaming":true,"maxTokensField":"max_tokens","supportsStrictMode":false,"thinkingFormat":"qwen-chat-template"},
			reasoning: true,
			input: ["text"],
			cost: {
				input: 1.32,
		...
		"route/kimi-k2.5": {
			...
			provider: "routing-run",
			baseUrl: "https://api.routing.run/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsUsageInStreaming":true,"maxTokensField":"max_tokens","supportsStrictMode":false,"thinkingFormat":"zai"},
			reasoning: true,
			input: ["text", "image"],
			cost: {
				input: 0.462,
		...
		"route/mimo-v2.5": {
			...
			provider: "routing-run",
			baseUrl: "https://api.routing.run/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsUsageInStreaming":true,"maxTokensField":"max_tokens","supportsStrictMode":false,"thinkingFormat":"qwen"},
			reasoning: true,
			input: ["text", "image"],
			cost: {
				input: 0.4,
		...
		"route/mistral-large-3": {
			...
			provider: "routing-run",
			baseUrl: "https://api.routing.run/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsUsageInStreaming":true,"maxTokensField":"max_tokens","supportsStrictMode":false},
			reasoning: false,
			input: ["text", "image"],
			cost: {
				input: 0.5,
