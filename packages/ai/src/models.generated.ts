...
export const MODELS = {
	...
	"xai-grok": {
		"grok-build": {
			...
			headers: {"X-XAI-Token-Auth":"xai-grok-cli","x-grok-client-version":"0.2.51","x-grok-model-override":"grok-build"},
		...
		"grok-composer-2.5-fast": {
			...
			provider: "xai-grok",
			baseUrl: "https://cli-chat-proxy.grok.com/v1",
			headers: {"X-XAI-Token-Auth":"xai-grok-cli","x-grok-client-version":"0.2.51","x-grok-model-override":"grok-composer-2.5-fast"},
			compat: {"sendSessionIdHeader":false,"supportsLongCacheRetention":false},
			reasoning: false,
			input: ["text"],
			cost: {
