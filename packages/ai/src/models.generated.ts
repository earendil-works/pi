...
export const MODELS = {
	...
	"palantir": {
		"ri.language-model-service..language-model.anthropic-claude-3-5-haiku": {
			id: "ri.language-model-service..language-model.anthropic-claude-3-5-haiku",
			name: "anthropic-claude-3-5-haiku",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/anthropic",
			compat: {"supportsEagerToolInputStreaming":false,"supportsCacheControlOnTools":false,"supportsPromptCaching":false},
			reasoning: true,
			input: ["text", "image"],
			cost: {
				input: 0,
			...
			contextWindow: 128000,
			maxTokens: 8192,
		} satisfies Model<"palantir-proxy">,
		"ri.language-model-service..language-model.anthropic-claude-3-haiku": {
			id: "ri.language-model-service..language-model.anthropic-claude-3-haiku",
			name: "anthropic-claude-3-haiku",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/anthropic",
		...
		"ri.language-model-service..language-model.anthropic-claude-4-1-opus": {
			id: "ri.language-model-service..language-model.anthropic-claude-4-1-opus",
		...
		"ri.language-model-service..language-model.anthropic-claude-4-5-haiku": {
			id: "ri.language-model-service..language-model.anthropic-claude-4-5-haiku",
		...
		"ri.language-model-service..language-model.anthropic-claude-4-5-opus": {
			id: "ri.language-model-service..language-model.anthropic-claude-4-5-opus",
		...
		"ri.language-model-service..language-model.anthropic-claude-4-5-sonnet": {
			id: "ri.language-model-service..language-model.anthropic-claude-4-5-sonnet",
		...
		"ri.language-model-service..language-model.anthropic-claude-4-6-opus": {
			id: "ri.language-model-service..language-model.anthropic-claude-4-6-opus",
		...
		"ri.language-model-service..language-model.anthropic-claude-4-6-sonnet": {
			id: "ri.language-model-service..language-model.anthropic-claude-4-6-sonnet",
		...
		"ri.language-model-service..language-model.anthropic-claude-4-7-opus": {
			id: "ri.language-model-service..language-model.anthropic-claude-4-7-opus",
		...
		"ri.language-model-service..language-model.anthropic-claude-4-8-opus": {
			id: "ri.language-model-service..language-model.anthropic-claude-4-8-opus",
		...
		"ri.language-model-service..language-model.anthropic-claude-4-opus": {
			id: "ri.language-model-service..language-model.anthropic-claude-4-opus",
		...
		"ri.language-model-service..language-model.anthropic-claude-4-sonnet": {
			id: "ri.language-model-service..language-model.anthropic-claude-4-sonnet",
		...
		"ri.language-model-service..language-model.gemini-2-5-flash": {
			id: "ri.language-model-service..language-model.gemini-2-5-flash",
			name: "gemini-2-5-flash",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/google/v1",
			reasoning: true,
			input: ["text", "image"],
			cost: {
				input: 0,
		...
		"ri.language-model-service..language-model.gemini-2-5-flash-lite": {
			id: "ri.language-model-service..language-model.gemini-2-5-flash-lite",
			name: "gemini-2-5-flash-lite",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/google/v1",
		...
		"ri.language-model-service..language-model.gemini-2-5-pro": {
			id: "ri.language-model-service..language-model.gemini-2-5-pro",
			name: "gemini-2-5-pro",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/google/v1",
		...
		"ri.language-model-service..language-model.gemini-3-1-flash-lite": {
			id: "ri.language-model-service..language-model.gemini-3-1-flash-lite",
			name: "gemini-3-1-flash-lite",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/google/v1",
		...
		"ri.language-model-service..language-model.gemini-3-1-pro": {
			id: "ri.language-model-service..language-model.gemini-3-1-pro",
			name: "gemini-3-1-pro",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/google/v1",
		...
		"ri.language-model-service..language-model.gemini-3-5-flash": {
			id: "ri.language-model-service..language-model.gemini-3-5-flash",
			name: "gemini-3-5-flash",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/google/v1",
		...
		"ri.language-model-service..language-model.gemini-3-flash": {
			id: "ri.language-model-service..language-model.gemini-3-flash",
			name: "gemini-3-flash",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/google/v1",
		...
		"ri.language-model-service..language-model.gpt-4-1": {
			id: "ri.language-model-service..language-model.gpt-4-1",
			name: "gpt-4-1",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
			reasoning: false,
			input: ["text", "image"],
			cost: {
				input: 0,
		...
		"ri.language-model-service..language-model.gpt-4-1-mini": {
			id: "ri.language-model-service..language-model.gpt-4-1-mini",
			name: "gpt-4-1-mini",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
		...
		"ri.language-model-service..language-model.gpt-4-1-nano": {
			id: "ri.language-model-service..language-model.gpt-4-1-nano",
			name: "gpt-4-1-nano",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
		...
		"ri.language-model-service..language-model.gpt-4-o": {
			id: "ri.language-model-service..language-model.gpt-4-o",
			name: "gpt-4-o",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
		...
		"ri.language-model-service..language-model.gpt-5": {
			id: "ri.language-model-service..language-model.gpt-5",
			name: "gpt-5",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
		...
		"ri.language-model-service..language-model.gpt-5-1": {
			id: "ri.language-model-service..language-model.gpt-5-1",
			name: "gpt-5-1",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
		...
		"ri.language-model-service..language-model.gpt-5-2": {
			id: "ri.language-model-service..language-model.gpt-5-2",
			name: "gpt-5-2",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
		...
		"ri.language-model-service..language-model.gpt-5-4": {
			id: "ri.language-model-service..language-model.gpt-5-4",
			name: "gpt-5-4",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
		...
		"ri.language-model-service..language-model.gpt-5-4-mini": {
			id: "ri.language-model-service..language-model.gpt-5-4-mini",
			name: "gpt-5-4-mini",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
		...
		"ri.language-model-service..language-model.gpt-5-4-nano": {
			id: "ri.language-model-service..language-model.gpt-5-4-nano",
			name: "gpt-5-4-nano",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
		...
		"ri.language-model-service..language-model.gpt-5-mini": {
			id: "ri.language-model-service..language-model.gpt-5-mini",
			name: "gpt-5-mini",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
		...
		"ri.language-model-service..language-model.gpt-5-nano": {
			id: "ri.language-model-service..language-model.gpt-5-nano",
			name: "gpt-5-nano",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
		...
		"ri.language-model-service..language-model.text-embedding-3-large_azure": {
			id: "ri.language-model-service..language-model.text-embedding-3-large_azure",
			name: "text-embedding-3-large_azure",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
			reasoning: false,
		...
		"ri.language-model-service..language-model.text-embedding-3-small_azure": {
			id: "ri.language-model-service..language-model.text-embedding-3-small_azure",
			name: "text-embedding-3-small_azure",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
			reasoning: false,
		...
		"ri.language-model-service..language-model.text-embedding-ada-002_azure": {
			id: "ri.language-model-service..language-model.text-embedding-ada-002_azure",
			name: "text-embedding-ada-002_azure",
			api: "palantir-proxy",
			provider: "palantir",
			baseUrl: "[PALANTIR_BASE_URL]/api/v2/llm/proxy/openai/v1",
			reasoning: false,
