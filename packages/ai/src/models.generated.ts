...
export const MODELS = {
	...
	"ant-ling": {
		...
		"Ring-2.6-1T": {
			...
			provider: "ant-ling",
			baseUrl: "https://api.ant-ling.com/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":false,"maxTokensField":"max_tokens","supportsStrictMode":false,"thinkingFormat":"ant-ling","requiresReasoningContentOnAssistantMessages":true},
			reasoning: true,
