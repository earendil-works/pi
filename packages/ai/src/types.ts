...
export interface OpenAICompletionsCompat {
	...
	/** Whether the provider uses Google-style `extra_content.google.thought_signature` on function-call parts (Gemini 3 via OpenAI-compatible endpoints), which must be captured from streams and echoed back on replayed tool calls. Default: false. */
