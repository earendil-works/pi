...
const sqliteNode = fileURLToPath(new URL("../sqlite-node/src/index.ts", import.meta.url));
const sqliteNodeCore = fileURLToPath(new URL("../sqlite-node/src/sqlite/core.ts", import.meta.url));
...
export default defineConfig({
	...
	resolve: {
		...
		alias: [
			...
			{ find: /^@earendil-works\/pi-session-backend-sqlite-node\/sqlite$/, replacement: sqliteNodeCore },
			{ find: /^@earendil-works\/pi-session-backend-sqlite-node$/, replacement: sqliteNode },
		],
	},
