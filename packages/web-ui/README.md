...
Reusable web UI components for building AI chat interfaces powered by [@tculpepp/pi-ai](../ai) and [@tculpepp/pi-agent-core](../agent).
...
```bash
npm install @tculpepp/pi-web-ui @tculpepp/pi-agent-core @tculpepp/pi-ai
```
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@tculpepp/pi-web-ui';
import '@tculpepp/pi-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@tculpepp/pi-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@tculpepp/pi-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@tculpepp/pi-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@tculpepp/pi-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@tculpepp/pi-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@tculpepp/pi-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@tculpepp/pi-web-ui';
...
```typescript
import { SessionListDialog } from '@tculpepp/pi-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@tculpepp/pi-web-ui';
...
```typescript
import { ModelSelector } from '@tculpepp/pi-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@tculpepp/pi-web-ui';
