...
Reusable web UI components for building AI chat interfaces powered by [@tculpepp/spi-ai](../ai) and [@tculpepp/spi-agent-core](../agent).
...
```bash
npm install @tculpepp/spi-web-ui @tculpepp/spi-agent-core @tculpepp/spi-ai
```
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@tculpepp/spi-web-ui';
import '@tculpepp/spi-web-ui/app.css';
...
declare module '@tculpepp/spi-agent-core' {
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@tculpepp/spi-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@tculpepp/spi-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@tculpepp/spi-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@tculpepp/spi-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@tculpepp/spi-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@tculpepp/spi-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@tculpepp/spi-web-ui';
...
```typescript
import { SessionListDialog } from '@tculpepp/spi-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@tculpepp/spi-web-ui';
...
```typescript
import { ModelSelector } from '@tculpepp/spi-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@tculpepp/spi-web-ui';
