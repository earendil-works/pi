...
- **Agent loop moved from `@tculpepp/pi-ai`**: The `agentLoop`, `agentLoopContinue`, and related types have moved to this package. Import from `@tculpepp/pi-agent-core` instead.
