...
For non-Windows cross-builds, or for custom Windows toolchains, set `SPI_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
SPI_TUI_WIN32_TOOLCHAIN=mingw \
