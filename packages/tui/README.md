...
On Windows 10, regular-screen content updates clear the screen and scrollback before repainting the full frame to prevent stale input and selector rows. This increases output during frequent updates and replaces terminal scrollback on each repaint. Windows 11 and other platforms use differential updates.
