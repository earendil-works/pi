...
| `invalidate()` | Called to clear any cached render state. Components should re-render from scratch on the next `render()` call. Components with no cached state can use an empty implementation. |
