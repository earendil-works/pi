 ...
 *
 *   mkdir -p ~/.spi/agent/extensions
 *   cp packages/coding-agent/examples/extensions/project-trust.ts ~/.spi/agent/extensions/
 *
 * Or:
 *
...
import type { ExtensionAPI, ProjectTrustEventResult } from "@tculpepp/spi-coding-agent";
