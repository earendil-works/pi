...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@tculpepp/spi-coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@tculpepp/spi-tui";
