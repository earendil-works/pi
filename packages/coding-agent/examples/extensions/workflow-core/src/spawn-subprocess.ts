/**
 * Subprocess spawning for isolated pi agent invocations
 */
...
import type { AgentResult, UsageStats } from "./types.ts";

export type AgentUpdateCallback = (result: AgentResult) => void;
...
export function getResultOutput(result: AgentResult): string {
...
export async function runSingleAgent(
	...
	const { cwd, step, stepPath, signal, onUpdate } = options;
