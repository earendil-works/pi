import { CustomEditor, type ExtensionAPI, type ExtensionContext, type KeybindingsManager } from "@lyla/coding-agent";
import type { Component, EditorTheme, TUI } from "@lyla/tui";
import { truncateToWidth, visibleWidth } from "@lyla/tui";
