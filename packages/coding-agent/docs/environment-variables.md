...
| `PI_OFFLINE` | Disable startup network operations, including update checks, package updates, install/update telemetry, and model network discovery unless explicitly allowed |
