...
| `thinkingFormat` | Use `reasoning_effort`, `openrouter`, `deepseek`, `together`, `zai`, `qwen`, `qwen-chat-template`, or `chat-template` thinking parameters |
