...
[`AgentSessionEvent`](https://github.com/tculpepp/secure-pi-mono/blob/main/packages/coding-agent/src/core/agent-session.ts)
...
[`AgentEvent`](https://github.com/tculpepp/secure-pi-mono/blob/main/packages/agent/src/types.ts):
