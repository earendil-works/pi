...
```typescript
import { createAgentSession, ModelRuntime, SessionManager } from "@mupt-ai/pi-coding-agent";
...
```bash
npm install @mupt-ai/pi-coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@mupt-ai/pi-coding-agent";
...
The `Agent` class (from `@mupt-ai/pi-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { ModelRuntime } from "@mupt-ai/pi-coding-agent";
...
```typescript
import { InMemoryCredentialStore } from "@mupt-ai/pi-ai";
import { createAgentSession, ModelRuntime } from "@mupt-ai/pi-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@mupt-ai/pi-coding-agent";
...
```typescript
import { createAgentSession } from "@mupt-ai/pi-coding-agent";
...
import { createAgentSession, defineTool } from "@mupt-ai/pi-coding-agent";
...
```typescript
import type { InlineExtension } from "@mupt-ai/pi-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@mupt-ai/pi-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@mupt-ai/pi-coding-agent";
