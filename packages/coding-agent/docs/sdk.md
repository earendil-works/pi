...
```typescript
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@lyla/coding-agent";
...
```typescript
import { createAgentSession, SessionManager } from "@lyla/coding-agent";
...
The `Agent` class (from `@lyla/agent`) handles the core LLM interaction. Access it via `session.agent`.
...
```typescript
import { getModel } from "@lyla/ai";
import { AuthStorage, ModelRegistry } from "@lyla/coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@lyla/coding-agent";
...
```typescript
import { createAgentSession } from "@lyla/coding-agent";
...
import { createAgentSession, defineTool } from "@lyla/coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@lyla/coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@lyla/coding-agent";
