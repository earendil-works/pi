...
For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @tculpepp/spi-coding-agent`, `yarn global remove @tculpepp/spi-coding-agent`, or `bun uninstall -g @tculpepp/spi-coding-agent`.
