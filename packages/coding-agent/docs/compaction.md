...
For TypeScript definitions in your project, inspect `node_modules/@lyla/coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@lyla/coding-agent";
