...
| Category | Colors |
|----------|--------|
| General | `text`, `accent`, `muted`, `dim`, `scrollToEndIndicatorText`, `searchMatchText` |
...
`selectedBg`, `scrollToEndIndicatorBg`, `searchMatchBg`, `userMessageBg`, `customMessageBg`, `toolPendingBg`, `toolSuccessBg`, `toolErrorBg`
