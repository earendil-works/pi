...
**Source:** [`@lyla/tui`](https://github.com/earendil-works/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@lyla/tui";
...
```typescript
import { Container, type Focusable, Input } from "@lyla/tui";
...
Import from `@lyla/tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@lyla/tui";
```
...
```typescript
import { matchesKey, Key } from "@lyla/tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@lyla/tui";
...
```typescript
import { getMarkdownTheme } from "@lyla/coding-agent";
import { Markdown } from "@lyla/tui";
...
For letting users pick from a list of options. Use `SelectList` from `@lyla/tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@lyla/coding-agent";
import { DynamicBorder } from "@lyla/coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@lyla/tui";
...
```typescript
import { BorderedLoader } from "@lyla/coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@lyla/tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@lyla/coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@lyla/tui";
...
import { matchesKey, truncateToWidth } from "@lyla/tui";
