...
${chalk.bold("Options:")}
  ...
  --offline                      Disable startup network operations (same as SPI_OFFLINE=1)
...
${chalk.bold("Environment Variables:")}
  ...
  SPI_PACKAGE_DIR                   - Override package directory (for Nix/Guix store paths)
  SPI_OFFLINE                       - Disable startup network operations when set to 1/true/yes
  SPI_TELEMETRY                     - Override install telemetry when set to 1/true/yes or 0/false/no
  SPI_SHARE_VIEWER_URL              - Base URL for /share command (default: https://pi.dev/session/)
