...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "@tculpepp/spi-ai";
 ...
 * Encodes cwd into a safe directory name under ~/.spi/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.spi/agent/sessions/<encoded-cwd>/).
	 */
