...
/** An inline extension factory, optionally tagged with a path used as its display name. */
export type ExtensionFactoryEntry = ExtensionFactory | { path: string; factory: ExtensionFactory };
