...
import type { Provider } from "@mupt-ai/pi-ai";
import * as _bundledPiAiCompat from "@mupt-ai/pi-ai/compat";
import * as _bundledPiAiOauth from "@mupt-ai/pi-ai/oauth";
import * as _bundledPiAiProviders from "@mupt-ai/pi-ai/providers/all";
...
// avoiding a circular dependency. Extensions can import from @mupt-ai/pi-coding-agent.
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@mupt-ai/pi-ai": _bundledPiAiCompat,
	"@mupt-ai/pi-ai/compat": _bundledPiAiCompat,
	"@mupt-ai/pi-ai/oauth": _bundledPiAiOauth,
	"@mupt-ai/pi-ai/providers/all": _bundledPiAiProviders,
...
function getAliases(): Record<string, string> {
	...
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	const piAiCompatEntry = resolveWorkspaceOrImport("ai/dist/compat.js", "@mupt-ai/pi-ai/compat");
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@mupt-ai/pi-ai/oauth");
	const piAiProvidersEntry = resolveWorkspaceOrImport("ai/dist/providers/all.js", "@mupt-ai/pi-ai/providers/all");

	_aliases = {
		"@mupt-ai/pi-coding-agent": piCodingAgentEntry,
		"@mupt-ai/pi-agent-core": piAgentCoreEntry,
		"@earendil-works/pi-tui": piTuiEntry,
		"@mupt-ai/pi-ai/providers/all": piAiProvidersEntry,
		"@mupt-ai/pi-ai/compat": piAiCompatEntry,
		"@mupt-ai/pi-ai/oauth": piAiOauthEntry,
		"@mupt-ai/pi-ai": piAiCompatEntry,
