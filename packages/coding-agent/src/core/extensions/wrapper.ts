 ...
 */
export function wrapRegisteredTool(registeredTool: RegisteredTool, runner: ExtensionRunner, cwd: string): AgentTool {
	return wrapToolDefinition(registeredTool.definition, () => runner.createContext(), cwd);
}
