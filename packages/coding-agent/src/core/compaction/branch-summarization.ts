...
import type { AgentRequestIdentity, RetryCallbacks, RetryPolicy } from "@earendil-works/pi-ai";
...
export interface GenerateBranchSummaryOptions {
	...
	/** Logical identity identifying this request as compaction rather than foreground work. */
