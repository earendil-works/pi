...
export function normalizeNulRedirects(command: string): string {
	...
	while (i < command.length) {
		...
		// In Bash, backslashes are literal inside single quotes, so a backslash
		// before a closing single quote does NOT escape it. Outside single quotes,
		// \' is an escaped literal quote and should not toggle quotes.
