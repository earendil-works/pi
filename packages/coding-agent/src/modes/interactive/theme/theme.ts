...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@tculpepp/spi-tui";
...
const THEME_KEY = Symbol.for("@tculpepp/spi-coding-agent:theme");
...
export function getSettingsListTheme(): import("@tculpepp/spi-tui").SettingsListTheme {
	return {
