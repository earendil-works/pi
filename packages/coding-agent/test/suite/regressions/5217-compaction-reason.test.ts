...
/**
 * Regression for https://github.com/earendil-works/pi/issues/5217
 *
 * Extension events session_before_compact and session_compact must carry
 * reason ("manual" | "threshold" | "overflow") and willRetry so that
 * extensions can distinguish compaction sources — the same way the RPC
 * API already does.
 *
 * Thank you to PizzaMarinara for the initial analysis and implementation
 * on her fork.
 */
