...
import type { AssistantMessage, Model } from "@mupt-ai/pi-ai";
...
vi.mock("@mupt-ai/pi-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@mupt-ai/pi-ai/compat")>();
	return {
		...actual,
