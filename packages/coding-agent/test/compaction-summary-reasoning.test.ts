...
import type { AssistantMessage, Context, Model } from "@tculpepp/spi-ai";
...
vi.mock("@tculpepp/spi-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@tculpepp/spi-ai/compat")>();
	return {
		...actual,
