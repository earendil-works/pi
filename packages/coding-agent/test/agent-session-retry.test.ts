...
import { Agent, type AgentEvent, type AgentTool } from "@tculpepp/spi-agent-core";
import { type AssistantMessage, type AssistantMessageEvent, EventStream, getModel } from "@tculpepp/spi-ai/compat";
