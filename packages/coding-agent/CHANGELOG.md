...
- Fixed auto-compaction waiting until the end of an agent run when tool results cross the context threshold; Pi now compacts before the next model request within the same turn.
