...
- Fixed context overflow during queued turns by compacting before send using system prompt and tool definition tokens, and muted recovered provider overflow errors in the TUI.
