...
- Added experimental SQLite session storage selection through `PERSISTENT_STORE=sqlite`, with JSONL import/export interoperability and JSONL remaining the default.
